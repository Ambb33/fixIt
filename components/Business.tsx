  ...
  <section id="features" className={`${layout.section}`}>
    <div className={layout.sectionInfo}>
      <h2 className={styles.heading2}>
        You take care of your daily life,
         <br className="sm:block hidden" />
         and we’ll take care of your tech.
      </h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      With our dedicated support, you can enjoy peace of mind knowing your 
      devices are in expert hands. Whether it's troubleshooting, repairs, 
      or setup, we simplify technology for you, so you can focus on what matters most."
      </p>
      <Button styles="mt-10" />
    </div>
